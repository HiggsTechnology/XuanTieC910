...
class AIQ0Data extends Bundle {
  ...
  val VSEW         = UInt(3.W)
  val VLMUL        = UInt(2.W)
  val LCH_RDY_SDIQ = Vec(8, UInt(3.W))
  val LCH_RDY_LSIQ = Vec(8, UInt(3.W))
  val LCH_RDY_BIQ  = Vec(12, UInt(2.W))
  val LCH_RDY_AIQ1 = Vec(12, UInt(2.W))
  val LCH_RDY_AIQ0 = Vec(12, Bool())
  val ALU_SHORT    = Bool()
  val PID          = UInt(5.W)
  val PCFIFO       = Bool()
  val MTVR         = Bool()
...
class AIQ1Data extends Bundle{
  ...
  val VSEW = UInt(3.W)
  val VLMUL = UInt(2.W)
  val LCH_RDY_SDIQ = UInt(12.W)
  val LCH_RDY_LSIQ = UInt(24.W)
  val LCH_RDY_BIQ = UInt(24.W)
  val LCH_RDY_AIQ1 = UInt(24.W)
  val LCH_RDY_AIQ0 = UInt(24.W)
  val ALU_SHORT = Bool()
  val MLA = Bool()
  val MTVR = Bool()
...
class VIQData extends Bundle {
  ...
  val VMLA_SHORT = Bool()
  val VDIV = Bool()//VIQ0
  val LCH_RDY_VIQ1 = UInt(8.W)
  val LCH_RDY_VIQ0 = UInt(8.W)
